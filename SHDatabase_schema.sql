...
ALTER TABLE [COSTS] WITH CHECK ADD CONSTRAINT [FK_COSTS_CHANNELS] FOREIGN KEY([CHANNEL_ID]) REFERENCES [CHANNELS] ([CHANNEL_ID]);
ALTER TABLE [COSTS] CHECK CONSTRAINT [FK_COSTS_CHANNELS];

ALTER TABLE [COSTS] WITH CHECK ADD CONSTRAINT [FK_COSTS_PRODUCTS] FOREIGN KEY([PROD_ID]) REFERENCES [PRODUCTS] ([PROD_ID]);
ALTER TABLE [COSTS] CHECK CONSTRAINT [FK_COSTS_PRODUCTS];

ALTER TABLE [COSTS] WITH CHECK ADD CONSTRAINT [FK_COSTS_PROMOTIONS] FOREIGN KEY([PROMO_ID]) REFERENCES [PROMOTIONS] ([PROMO_ID]);
ALTER TABLE [COSTS] CHECK CONSTRAINT [FK_COSTS_PROMOTIONS];

ALTER TABLE [COSTS] WITH CHECK ADD CONSTRAINT [FK_COSTS_TIMES] FOREIGN KEY([TIME_ID]) REFERENCES [TIMES] ([TIME_ID]);
...
ALTER TABLE [SALES] WITH CHECK ADD CONSTRAINT [FK_SALES_CHANNELS] FOREIGN KEY([CHANNEL_ID]) REFERENCES [CHANNELS] ([CHANNEL_ID]);
ALTER TABLE [SALES] CHECK CONSTRAINT [FK_SALES_CHANNELS];

ALTER TABLE [SALES] WITH CHECK ADD CONSTRAINT [FK_SALES_CUSTOMERS] FOREIGN KEY([CUST_ID]) REFERENCES [CUSTOMERS] ([CUST_ID]);
ALTER TABLE [SALES] CHECK CONSTRAINT [FK_SALES_CUSTOMERS];

ALTER TABLE [SALES] WITH CHECK ADD CONSTRAINT [FK_SALES_PRODUCTS] FOREIGN KEY([PROD_ID]) REFERENCES [PRODUCTS] ([PROD_ID]);
ALTER TABLE [SALES] CHECK CONSTRAINT [FK_SALES_PRODUCTS];

ALTER TABLE [SALES] WITH CHECK ADD CONSTRAINT [FK_SALES_PROMOTIONS] FOREIGN KEY([PROMO_ID]) REFERENCES [PROMOTIONS] ([PROMO_ID]);
ALTER TABLE [SALES] CHECK CONSTRAINT [FK_SALES_PROMOTIONS];

ALTER TABLE [SALES] WITH CHECK ADD CONSTRAINT [FK_SALES_TIMES] FOREIGN KEY([TIME_ID]) REFERENCES [TIMES] ([TIME_ID]);
